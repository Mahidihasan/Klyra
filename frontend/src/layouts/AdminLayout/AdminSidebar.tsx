  ...
  return (
    <aside className="admin-sidebar stagger-1 h-screen flex flex-col">
      ...
      <nav className="admin-nav flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        {(hasPermission('VIEW_APIS') || hasPermission('CURATE_MARKETPLACE_FEATURED')) && (
          <div 
        ...
        {(hasPermission('VIEW_BILLING_INVOICES') || hasPermission('VIEW_SUBSCRIPTIONS')) && (
          <div 
        ...
        {(hasPermission('VIEW_MODERATION_INBOX') || hasPermission('VIEW_SYSTEM_LOGS') || hasPermission('VIEW_AI_THREAT_DETECTION') || hasPermission('ACCESS_RBAC_MATRIX') || hasPermission('VIEW_SECURITY_CENTER') || hasPermission('MANAGE_CORE_SETTINGS')) && (
          <div 
            className={`admin-nav-item ${activeTab === 'admin-activity' ? 'active' : ''}`}
            onClick={() => setActiveTab('admin-activity')}
          >
            <ShieldAlert size={18} />
            Reports & Core Settings
          </div>
        )}

        {hasPermission('VIEW_DATABASE_METRICS') && (
          <div 
        ...
        {hasPermission('ACCESS_ENGINE_ROOM') && (
          <div 
        ...
        {hasPermission('VIEW_SERVER_HEALTH') && (
          <div 
        ...
        {(hasPermission('VIEW_TACTICAL_BOARD') || hasPermission('VIEW_INVOICE_FORENSICS')) && (
          <div 
