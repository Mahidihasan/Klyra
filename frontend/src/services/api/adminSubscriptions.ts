import { AdminSubscriptionRow, GlobalTierTemplate } from '../../types/adminSubscriptions';
import { AdminApiError } from './admin';

const API_BASE_URL = '/api/v1/admin/subscriptions';
...
export const adminSubscriptionsApi = {
  async getSubscriptions(filters: { status?: string; search?: string }, signal?: AbortSignal) {
